...
For detailed database setup, see [DATABASE_SETUP.md](DATABASE_SETUP.md) and [DATABASE_IMPORT_GUIDE.md](DATABASE_IMPORT_GUIDE.md).
...
For complete schema details, see the migration files in `database/migrations/`.
...
For complete API documentation, see the route definitions in `routes/api.php`.
...
Email templates are located in `resources/mail/`.
...
See [Sprint-2.md](Sprint-2.md) for detailed sprint information.
